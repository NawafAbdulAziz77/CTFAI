...
API_KEY = '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'
        ...
        system_messages = [
            {
                "role": "system",
                "content": (
                    "Kamu adalah pembuat soal Capture The Flag (CTF) profesional yang berpengalaman. "
                    "Tugasmu adalah membuat satu soal CTF yang lengkap, menantang namun sesuai tingkat kesulitan, dan disertai dengan write-up (jawaban/solusi teknis)."
                )
            },
            {
                "role": "system",
                "content": (
                    "Format soal CTF yang harus kamu hasilkan adalah sebagai berikut, dan semuanya ditulis dalam Bahasa Indonesia:\n\n"
                    "Kategori: <kategori>\n"
                    "Topik: <topik>\n"
                    "Tingkat Kesulitan: <mudah/sedang/sulit>\n"
                    "Soal: <deskripsi soal yang harus diselesaikan>\n"
                    "Hint: <petunjuk untuk peserta>\n"
                    "Nilai: <angka skor, misal 50>\n"
                    "Ctf: <flag dengan format PolinesCTF{...}>\n"
                    "Write-up: <penjelasan langkah-langkah penyelesaian soal hingga mendapatkan flag>\n"
                    "Jika soal yang kamu buat membutuhkan file pendukung (misalnya HTML, script, atau binary), "
                    "sertakan isi file tersebut menggunakan format:\n"
                    "---file:<nama_file>---\n<isi file>\n---\n"
                    "Jika tidak ada file, cukup kosongkan bagian itu."
                )
            }
        ]
